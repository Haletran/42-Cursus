...
/*   Updated: 2024/04/17 16:57:41 by bapasqui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	key_hook(int key, void *param)
{
	...
	if ((key == KEY_W || key == UP_ARROW) && mlx->map->map[(int)(mlx->player->y + mlx->player->delta_y) / 32][(int)(mlx->player->x + mlx->player->delta_x) / 32] != '1')
    {
    ...
    if ((key == KEY_S || key == DOWN_ARROW) && mlx->map->map[(int)(mlx->player->y - mlx->player->delta_y) / 32][(int)(mlx->player->x - mlx->player->delta_x) / 32] != '1')
    {
        mlx->player->x -= mlx->player->delta_x;
        mlx->player->y -= mlx->player->delta_y;
    }
